...
export default function CloudCardScreen() {
  ...
  useEffect(() => {
    // Get cloud data from location state or history
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-gradient-to-b from-sky-400 via-sky-200 to-blue-50 p-4 flex flex-col">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <h2 className="text-xl font-bold text-white">Cloud Character</h2>
        <div className="w-11" />
      </div>
      ...
      >
        ...
        <div className="relative mb-6 rounded-2xl overflow-hidden bg-gray-200">
          {cloudData.imageData ? (
            ...
            <div className="w-full aspect-square bg-gradient-to-br from-sky-200 to-blue-100 flex items-center justify-center">
