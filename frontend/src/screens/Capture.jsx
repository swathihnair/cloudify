  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-gradient-to-b from-sky-400 via-sky-200 to-blue-50 p-4">
      ...
      <motion.div
        ...
        className="rounded-3xl bg-white/80 backdrop-blur-md shadow-sm border border-white/60 p-6 mb-6"
      >
        {!preview ? (
          <div className="aspect-square bg-gradient-to-br from-sky-100 to-blue-100 rounded-2xl flex flex-col items-center justify-center border-2 border-dashed border-sky-300">
      ...
      <div className="space-y-3">
        <motion.button
          ...
          className="w-full rounded-2xl bg-white text-sky-600 px-6 py-4 font-semibold shadow-lg flex items-center justify-center gap-3"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          onClick={() => fileInputRef.current?.click()}
          className="w-full rounded-2xl bg-white/80 backdrop-blur-md text-sky-700 px-6 py-4 font-medium shadow-md flex items-center justify-center gap-3"
        >
